...
<blockquote class="text-center">
	...
	<p><h1><span class="glyphicon glyphicon-home"></span> {{ $relation->company }}</h1></p>
	<p><h1><span class="glyphicon glyphicon-send"></span> <a href="mailto: {{ $relation->email }}">{{ $relation->email }}</a></h1></p>
	<p><h1><span class="glyphicon glyphicon-earphone"></span> <a href="tel: {{ $relation->phone }}">{{ $relation->phone }}</a></h1></p>
</blockquote>
<br /><br />
